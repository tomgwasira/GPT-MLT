/*******************************************************************************
*
* Main program (entry point) for the Thevenin instrument software. 
* Project configurations and Interrupt Service Routines (ISRs) are also
* implemented here.
*
* Author: Stanley Adams (stanley@mltinverters.com), MLT Inverters
